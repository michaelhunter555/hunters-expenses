...
export const columns: GridColDef[] = [
  { field: "pageTitle", headerName: "Activity", flex: 1.5, minWidth: 200 },
  {
    field: "status",
    headerName: "Status",
    flex: 0.5,
